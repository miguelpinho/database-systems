...
VALUES ('Bailey', 15467, 'pug', 'white', 'male', '2010-12-07', 7),
       ...
       ('Germildes', 84698, 'bird', 'lilac', 'male', '2015-01-01', 3),
       ('Tina', 84698, 'python', 'red', 'female', '2014-01-01', 4);
...
INSERT INTO consult
VALUES ('Bailey', 15467, '2017-01-19 10:00:00', 15467, 2228, 15.1, 's', 'o', 'a', 'p'),
       ...
       ('Max', 15467, '2017-09-11 10:00:00', 15467, 1010, 33.1, 's', 'obese, much fat', 'a', 'p'),
       ...
       ('Buddy', 84698, '2017-10-11 15:00:00', 3366, 9126, 15.1, 's', 'o', 'a', 'p'),
...
INSERT INTO participation
VALUES ('Summer', 86137, '2017-03-03 15:00:00', 5121),
